...
added in between, changing \texttt{x} (excepting pathological cases
of distributed code collaboration).

This is not true in the environment \rad{} is intended to operate. In this
...
\rad{} adopts in general (and can be found sporadically in other languages, such as
...
partial-evaluation-based approaches such as those described in \cite{Brown2017}.
...
languages such as Haskell, Clojure, Erlang.

Immutable values and refs allows for more \textit{local} reasoning of the
