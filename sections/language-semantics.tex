...
in the context of a blockchain \cite{Nakamoto12}, where expressions are
...
indeed what some smart contract \cite{Szabo94} languages do, and can easily be implemented in
