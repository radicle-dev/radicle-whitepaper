...
% TODO: What's this mini-intro for?

\subsubsection{The Root and Radicle}
\label{s:root}

% TODO: Doesn't flow here.
...
% TODO: Something about "This programming paradigm/environment can be used to..."
% TODO: Reference lisp/scheme.

% read-eval-apply loop?
% read-eval-commit loop?
...
% TODO: Talk about following chains, and about how to read the full chain you
% have to go all the way to the radicle, and how as you go up, the chain-id changes
% because in the end, all chains except the root is a branch.
