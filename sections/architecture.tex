...
consistency guarantees~\cite{causal-consistency} and partial ordering across
chains.

\subsubsection{Block-lattice Architecture}

Block-lattices are a replicated data-structure composed of chains of blocks
which allow both parallel and synchronized operations to be expressed.  A pair
of transactions on two chains are either considered \emph{free}, if they may be
processed in parallel, or \emph{synchronized}, if a dependency (causal or
acausal) exists between them.

% TODO: Is "dependent" a better word for "synchronized"?
% TODO: Organize txs according to free/dependent?
% TODO: Categorize types of transactions and explain them?
