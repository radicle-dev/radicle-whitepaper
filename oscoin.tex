...
\setlist[description]{leftmargin=1.5cm, labelindent=\parindent}
\setlist[enumerate]{leftmargin=1.5cm, labelindent=\parindent}

\title{Oscoin: A Network for Sustainable Open-Source Hosting and Collaboration}
\author{Monadic}
\date{2018}
...
{\leftskip=2cm \def\epigraph@author{#2} \itshape}
{\par\normalfont\hfill---\ \epigraph@author\hspace*{1cm}\par\bigskip}
\makeatother
